...
TOOLS: dict[str, dict[str, Any]] = {
    ...
    "get_evidence": {"title": "Get evidence", "description": "Retrieve canonical provenance by evidence ID.", "input_schema": _args({"evidence_id": IDENTIFIER, "observation_id": IDENTIFIER, "action_id": IDENTIFIER}, []), "supported_worlds": ["real"],},
