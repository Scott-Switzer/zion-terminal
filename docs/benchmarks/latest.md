...
|---|---|---|---|---|---|---|
| `sample_html_filing.html` | 2.1 | Yes | 5 | dom | 81.4 | 0.774 |
| `sample_html_filing_div_headers.html` | 1.3 | Yes | 5 | dom | 1.4 | 0.652 |
| `sample_html_filing_table_toc.html` | 3.0 | Yes | 9 | dom | 2.8 | 0.723 |
| `sample_html_filing_wrapper.html` | 1.4 | Yes | 1 | dom | 0.9 | 0.82 |
